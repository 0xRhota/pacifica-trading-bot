...
class BotConfig:
    ...
    MIN_PROFIT_THRESHOLD = 0.05    # 5% minimum profit to close - let winners run
    MAX_LOSS_THRESHOLD = 0.003     # 0.3% maximum loss before closing - tight stop loss
    ...
    # Symbols to trade - rotated through in order
    TRADING_SYMBOLS = [
        "SOL",
        "PENGU",
        "BTC",
